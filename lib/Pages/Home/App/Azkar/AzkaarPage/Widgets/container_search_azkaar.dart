...
import 'package:quraan_app1/Pages/Home/App/Azkar/AzkaarPage/Widgets/search_delegate_azkaar.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          showSearch(context: context, delegate: SearchDelegateWidget2());
        },
        child: Container(
